"use strict";
// nact requires dispatch, spawn and system arg, importing the first to here
// when we call todo from lib, we pass system as the parent which will start it.
...
const spawnTodoService = (parent, todoData) => spawn(
    parent,
    (state = {
        todos: { todoData },
    }, msg, ctx) => {
